...
run_case() {
  ...
  (
    ...
    GLUETUN_CONTROL_PORT="${ARRSTACK_DEFAULT_GLUETUN_CONTROL_PORT}"
    ...
    SABNZBD_ENABLED=0
    SABNZBD_USE_VPN=0
    CADDY_HTTP_PORT="${ARRSTACK_DEFAULT_CADDY_HTTP_PORT}"
    CADDY_HTTPS_PORT="${ARRSTACK_DEFAULT_CADDY_HTTPS_PORT}"
...
main() {
  local -a cases=(
    "lan_unknown:LAN_IP=0.0.0.0 CADDY_HTTP_PORT=$((ARRSTACK_DEFAULT_CADDY_HTTP_PORT + 18000)) CADDY_HTTPS_PORT=$((ARRSTACK_DEFAULT_CADDY_HTTPS_PORT + 18000))"
    "lan_known:LAN_IP=192.168.55.12 CADDY_HTTP_PORT=$((ARRSTACK_DEFAULT_CADDY_HTTP_PORT + 8008)) CADDY_HTTPS_PORT=$((ARRSTACK_DEFAULT_CADDY_HTTPS_PORT + 8000))"
  )
