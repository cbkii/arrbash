...
: "${ARRSTACK_DEFAULT_CADDY_HTTP_PORT:=80}"
: "${ARRSTACK_DEFAULT_CADDY_HTTPS_PORT:=443}"
CADDY_HTTP_PORT="${CADDY_HTTP_PORT:-${ARRSTACK_DEFAULT_CADDY_HTTP_PORT}}"
...
: "${ARRSTACK_DEFAULT_GLUETUN_CONTROL_PORT:=8000}"
...
# Service ports
: "${ARRSTACK_DEFAULT_QBT_WEBUI_PORT:=8082}"
: "${ARRSTACK_DEFAULT_QBT_HTTP_PORT:=8082}"
: "${ARRSTACK_DEFAULT_SONARR_PORT:=8989}"
: "${ARRSTACK_DEFAULT_RADARR_PORT:=7878}"
: "${ARRSTACK_DEFAULT_PROWLARR_PORT:=9696}"
: "${ARRSTACK_DEFAULT_BAZARR_PORT:=6767}"
: "${ARRSTACK_DEFAULT_FLARESOLVERR_PORT:=8191}"
: "${ARRSTACK_DEFAULT_SABNZBD_PORT:=8080}"
: "${ARRSTACK_DEFAULT_SABNZBD_INTERNAL_PORT:=8080}"
QBT_WEBUI_PORT="${QBT_WEBUI_PORT:-${ARRSTACK_DEFAULT_QBT_WEBUI_PORT}}"
...
SABNZBD_PORT="${SABNZBD_PORT:-${ARRSTACK_DEFAULT_SABNZBD_PORT}}"
SABNZBD_INTERNAL_PORT="${SABNZBD_INTERNAL_PORT:-${ARRSTACK_DEFAULT_SABNZBD_INTERNAL_PORT}}"
...
# --- Service ports ---
QBT_HTTP_PORT="${QBT_HTTP_PORT}"              # qBittorrent WebUI port exposed on the LAN (default: ${QBT_HTTP_PORT})
