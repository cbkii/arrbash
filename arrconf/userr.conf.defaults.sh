...
# qBittorrent tracker list auto-updater
QBT_TRACKER_UPDATE_ENABLED="${QBT_TRACKER_UPDATE_ENABLED:-0}"
QBT_TRACKER_UPDATE_INTERVAL_HOURS="${QBT_TRACKER_UPDATE_INTERVAL_HOURS:-48}"
QBT_TRACKER_UPDATE_RETRY_HOURS="${QBT_TRACKER_UPDATE_RETRY_HOURS:-12}"
QBT_TRACKER_UPDATE_URL="${QBT_TRACKER_UPDATE_URL:-https://cf.trackerslist.com/all.txt}"
